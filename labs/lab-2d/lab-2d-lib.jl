...
function find_student_index(students::Array{Student,1}; sid::Int64=0, netid::String="abc123")::Union{Int64, Nothing}
...
#c pass values
test_idx = find_student_index(test_std_array; sid = test_std.sid, netid = test_sid.netid)
